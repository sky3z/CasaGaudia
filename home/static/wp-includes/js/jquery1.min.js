! function(e, t) {
  ...
  f.fn = f.prototype = {
    ...
    makeArray: function(e, t) {
      var n = t || [];
      return null != e && (g(Object(e)) ? f.merge(n, "string" == typeof e ? [e] : e) : o.call(n, e)), n
    },
    ...
    proxy: function(e, t) {
      var n, i, o;
      if ("string" == typeof t && (o = e[t], t = e, e = o), f.isFunction(e)) return n = r.call(arguments, 2), (i = function() {
  ...
  var y = function(e) {
    ...
    function ie(e, t, r, i) {
      ...
      if ((t ? t.ownerDocument || t : w) !== p && d(t), r = r || [], !e || "string" != typeof e) return r;
          ...
          var n = t.length > 0,
            ...
            o = function(o, a, s, l, c) {
              var f, d, h, m = 0,
                ...
                C = x.length;
              for (c && (u = a !== p && a); g !== C && null != (f = x[g]); g++) {
                if (i && f) {
                  for (d = 0; h = e[d++];)
                    if (h(f, a, s)) {
                      l.push(f);
                ...
                n && ((f = !h && f) && m--, o && y.push(f))
              }
              if (m += g, n && g !== m) {
                for (d = 0; h = t[d++];) h(y, v, a, s);
                if (o) {
                  if (m > 0)
                    for (; g--;) y[g] || v[g] || (v[g] = H.call(l));
                  v = ve(v)
                }
                q.apply(l, v), c && !o && v.length > 0 && m + t.length > 1 && ie.uniqueSort(l)
              }
              return c && (T = w, u = b), y
            };
          return n ? ae(o) : o
  ...
  var v = f.expr.match.needsContext,
    b = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    x = /^.[^:#\[\.,]*$/;
  ...
  f.filter = function(e, t, n) {
    ...
    is: function(e) {
      return !!w(this, "string" == typeof e && v.test(e) ? f(e) : e || [], !1).length
    }
  });
  var T, C = e.document,
    N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
  (f.fn.init = function(e, t) {
    ...
    if (!e) return this;
    if ("string" == typeof e) {
      if (!(n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : N.exec(e)) || !n[1] && t) return !t || t.jquery ? (t || T).find(e) : this.constructor(t).find(e);
      if (n[1]) {
        if (t = t instanceof f ? t[0] : t, f.merge(this, f.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), b.test(n[1]) && f.isPlainObject(t))
    ...
    return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : f.isFunction(e) ? void 0 !== T.ready ? T.ready(e) : e(f) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), f.makeArray(e, this))
  }).prototype = f.fn, T = f(C);
  ...
  f.extend({
    ...
    closest: function(e, t) {
      for (var n, r = 0, i = this.length, o = [], a = v.test(e) || "string" != typeof e ? f(e, t || this.context) : 0; r < i; r++)
    ...
    f.fn[e] = function(n, r) {
      ...
      return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = f.filter(r, i)), this.length > 1 && (k[e] || (i = f.unique(i)), E.test(e) && (i = i.reverse())), this.pushStack(i)
    }
  });
  var A, D = /\S+/g,
    j = {};
  ...
  function L() {
    C.addEventListener ? (C.removeEventListener("DOMContentLoaded", H, !1), e.removeEventListener("load", H, !1)) : (C.detachEvent("onreadystatechange", H), e.detachEvent("onload", H))
  }

  function H() {
    (C.addEventListener || "load" === event.type || "complete" === C.readyState) && (L(), f.ready())
  }
  f.Callbacks = function(e) {
    e = "string" == typeof e ? j[e] || function(e) {
      var t = j[e] = {};
      ...
      c = {
        ...
        remove: function() {
          return s && f.each(arguments, function(e, n) {
            for (var r;
              (r = f.inArray(n, s, r)) > -1;) s.splice(r, 1), t && (r <= i && i--, r <= o && o--)
          }), this
        },
        has: function(e) {
    ...
    when: function(e) {
      ...
      if (s > 1)
        for (t = new Array(s), n = new Array(s), i = new Array(s); o < s; o++) a[o] && f.isFunction(a[o].promise) ? a[o].promise().done(c(o, i, a)).fail(u.reject).progress(c(o, n, t)) : --l;
    ...
    ready: function(e) {
      if (!0 === e ? !--f.readyWait : !f.isReady) {
        ...
        f.isReady = !0, !0 !== e && --f.readyWait > 0 || (A.resolveWith(C, [f]), f.fn.triggerHandler && (f(C).triggerHandler("ready"), f(C).off("ready")))
      }
    }
  }), f.ready.promise = function(t) {
    if (!A)
      if (A = f.Deferred(), "complete" === C.readyState) setTimeout(f.ready);
      else if (C.addEventListener) C.addEventListener("DOMContentLoaded", H, !1), e.addEventListener("load", H, !1);
    else {
  ...
  function R(e, t, n) {
    if (f.acceptData(e)) {
      ...
      if (a[s]) {
        ...
        }(n || (delete a[s].data, B(a[s]))) && (o ? f.cleanData([e], !0) : c.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
      }
    }
  }
  f.extend({
    ...
    data: function(e, t) {
      ...
      if (void 0 === e) {
        if (this.length && (i = f.data(o), 1 === o.nodeType && !f._data(o, "parsedAttrs"))) {
          for (n = a.length; n--;) a[n] && 0 === (r = a[n].name).indexOf("data-") && F(o, r = f.camelCase(r.slice(5)), i[r]);
    ...
    queue: function(e, t, n) {
      var r;
      if (e) return t = (t || "fx") + "queue", r = f._data(e, t), n && (!r || f.isArray(n) ? r = f._data(e, t, f.makeArray(n)) : r.push(n)), r || []
    },
  ...
  f.event = {
    ...
    add: function(e, t, n, r, i) {
      var o, a, s, l, u, c, d, p, h, m, g, y = f._data(e);
      if (y) {
        for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = f.guid++), (a = y.events) || (a = y.events = {}), (c = y.handle) || ((c = y.handle = function(e) {
            return typeof f === q || e && f.event.triggered === e.type ? void 0 : f.event.dispatch.apply(c.elem, arguments)
          }).elem = e), s = (t = (t || "").match(D) || [""]).length; s--;) h = g = (o = G.exec(t[s]) || [])[1], m = (o[2] || "").split(".").sort(), h && (u = f.event.special[h] || {}, h = (i ? u.delegateType : u.bindType) || h, u = f.event.special[h] || {}, d = f.extend({
          type: h,
          origType: g,
          data: r,
          handler: n,
    ...
    remove: function(e, t, n, r, i) {
      var o, a, s, l, u, c, d, p, h, m, g, y = f.hasData(e) && f._data(e);
      if (y && (c = y.events)) {
        for (u = (t = (t || "").match(D) || [""]).length; u--;)
          if (h = g = (s = G.exec(t[u]) || [])[1], m = (s[2] || "").split(".").sort(), h) {
            ...
            l && !p.length && (d.teardown && !1 !== d.teardown.call(e, m, y.handle) || f.removeEvent(e, h, y.handle), delete c[h])
          } else
            for (h in c) f.event.remove(e, h + t[u], n, r, !0);
        f.isEmptyObject(c) && (delete y.handle, f._removeData(e, "events"))
      }
    },
    trigger: function(t, n, r, i) {
      var o, a, s, l, c, d, p, h = [r || C],
        m = u.call(t, "type") ? t.type : t,
        g = u.call(t, "namespace") ? t.namespace.split(".") : [];
      if (s = d = r = r || C, 3 !== r.nodeType && 8 !== r.nodeType && !Y.test(m + f.event.triggered) && (m.indexOf(".") >= 0 && (g = m.split("."), m = g.shift(), g.sort()), a = m.indexOf(":") < 0 && "on" + m, (t = t[f.expando] ? t : new f.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = g.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : f.makeArray(n, [t]), c = f.event.special[m] || {}, i || !c.trigger || !1 !== c.trigger.apply(r, n))) {
        if (!i && !c.noBubble && !f.isWindow(r)) {
          for (l = c.delegateType || m, Y.test(l + m) || (s = s.parentNode); s; s = s.parentNode) h.push(s), d = s;
          d === (r.ownerDocument || C) && h.push(d.defaultView || d.parentWindow || e)
        }
        for (p = 0;
      ...
      if (s && l.nodeType && (!e.button || "click" !== e.type))
        for (; l != this; l = l.parentNode || this)
          if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
            for (i = [], o = 0; o < s; o++) void 0 === i[n = (r = t[o]).selector + " "] && (i[n] = r.needsContext ? f(n, this).index(l) >= 0 : f.find(n, this, null, [l]).length), i[n] && i.push(r);
            i.length && a.push({
              elem: l,
              handlers: i
            })
    ...
    fix: function(e) {
      ...
      var t, n, r, i = e.type,
        o = e,
        a = this.fixHooks[i];
      for (a || (this.fixHooks[i] = a = J.test(i) ? this.mouseHooks : V.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new f.Event(o), t = r.length; t--;) e[n = r[t]] = o[n];
    ...
    e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Q : K) : this.type = e, t && f.extend(this, t), this.timeStamp = e && e.timeStamp || f.now(), this[f.expando] = !0
  }, f.Event.prototype = {
  ...
  function ge(e, t) {
    var n, r, i = 0,
      o = typeof e.getElementsByTagName !== q ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== q ? e.querySelectorAll(t || "*") : void 0;
    if (!o)
      for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || f.nodeName(r, t) ? o.push(r) : f.merge(o, ge(r, t));
  ...
  he.optgroup = he.option, he.tbody = he.tfoot = he.colgroup = he.caption = he.thead, he.th = he.td, f.extend({
    clone: function(e, t, n) {
      var r, i, o, a, s, l = f.contains(e.ownerDocument, e);
      if (c.html5Clone || f.isXMLDoc(e) || !re.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (me.innerHTML = e.outerHTML, me.removeChild(o = me.firstChild)), !(c.noCloneEvent && c.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || f.isXMLDoc(e)))
        for (r = ge(o), s = ge(e), a = 0; null != (i = s[a]); ++a) r[a] && Ce(i, r[a]);
      if (t)
        if (n)
          for (s = s || ge(e), r = r || ge(o), a = 0; null != (i = s[a]); a++) Te(i, r[a]);
        else Te(e, o);
      return (r = ge(o, "script")).length > 0 && we(r, !l && ge(e, "script")), r = s = i = null, o
    },
    buildFragment: function(e, t, n, r) {
      for (var i, o, a, s, l, u, d, p = e.length, h = ee(t), m = [], g = 0; g < p; g++)
        if ((o = e[g]) || 0 === o)
          if ("object" === f.type(o)) f.merge(m, o.nodeType ? [o] : o);
          else if (le.test(o)) {
        for (s = s || h.appendChild(t.createElement("div")), l = (ae.exec(o) || ["", ""])[1].toLowerCase(), d = he[l] || he._default, s.innerHTML = d[1] + o.replace(oe, "<$1></$2>") + d[2], i = d[0]; i--;) s = s.lastChild;
        if (!c.leadingWhitespace && ie.test(o) && m.push(t.createTextNode(ie.exec(o)[0])), !c.tbody)
          for (i = (o = "table" !== l || se.test(o) ? "<table>" !== d[1] || se.test(o) ? 0 : s : s.firstChild) && o.childNodes.length; i--;) f.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
        for (f.merge(m, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
        s = h.lastChild
      } else m.push(t.createTextNode(o));
      for (s && h.removeChild(s), c.appendChecked || f.grep(ge(m, "input"), ye), g = 0; o = m[g++];)
        if ((!r || -1 === f.inArray(o, r)) && (a = f.contains(o.ownerDocument, o), s = ge(h.appendChild(o), "script"), a && we(s), n))
    ...
    cleanData: function(e, t) {
      for (var r, i, o, a, s = 0, l = f.expando, u = f.cache, d = c.deleteExpando, p = f.event.special; null != (r = e[s]); s++)
        if ((t || f.acceptData(r)) && (a = (o = r[l]) && u[o])) {
          ...
          u[o] && (delete u[o], d ? delete r[l] : typeof r.removeAttribute !== q ? r.removeAttribute(l) : r[l] = null, n.push(o))
        }
    }
  }), f.fn.extend({
    text: function(e) {
    ...
    remove: function(e, t) {
      for (var n, r = e ? f.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || f.cleanData(ge(n)), n.parentNode && (t && f.contains(n.ownerDocument, n) && we(ge(n, "script")), n.parentNode.removeChild(n));
      return this
    },
    empty: function() {
      for (var e, t = 0; null != (e = this[t]); t++) {
        for (1 === e.nodeType && f.cleanData(ge(e, !1)); e.firstChild;) e.removeChild(e.firstChild);
    ...
    html: function(e) {
      return I(this, function(e) {
        ...
        if ("string" == typeof e && !ue.test(e) && (c.htmlSerialize || !re.test(e)) && (c.leadingWhitespace || !ie.test(e)) && !he[(ae.exec(e) || ["", ""])[1].toLowerCase()]) {
          e = e.replace(oe, "<$1></$2>");
          try {
            for (; n < r; n++) 1 === (t = this[n] || {}).nodeType && (f.cleanData(ge(t, !1)), t.innerHTML = e);
            t = 0
          } catch (e) {}
        }
    ...
    replaceWith: function() {
      ...
      return this.domManip(arguments, function(t) {
        e = this.parentNode, f.cleanData(ge(this)), e && e.replaceChild(t, this)
    ...
    domManip: function(e, t) {
      ...
      var n, r, o, a, s, l, u = 0,
        ...
        m = e[0],
        g = f.isFunction(m);
      if (g || d > 1 && "string" == typeof m && !c.checkClone && ce.test(m)) return this.each(function(n) {
        var r = p.eq(n);
      ...
      if (d && (n = (l = f.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === l.childNodes.length && (l = n), n)) {
        for (o = (a = f.map(ge(l, "script"), be)).length; u < d; u++) r = l, u !== h && (r = f.clone(r, !0, !0), o && f.merge(a, ge(r, "script"))), t.call(this[u], r, u);
        if (o)
          for (s = a[a.length - 1].ownerDocument, f.map(a, xe), u = 0; u < o; u++) r = a[u], fe.test(r.type || "") && !f._data(r, "globalEval") && f.contains(s, r) && (r.src ? f._evalUrl && f._evalUrl(r.src) : f.globalEval((r.text || r.textContent || r.innerHTML || "").replace(pe, "")));
        l = n = null
      }
      return this
    }
    ...
    f.fn[e] = function(e) {
      for (var n, r = 0, i = [], a = f(e), s = a.length - 1; r <= s; r++) n = r === s ? this : this.clone(!0), f(a[r])[t](n), o.apply(i, n.get());
  ...
  function Ae(e) {
    var t = C,
      n = ke[e];
    return n || ("none" !== (n = Se(e, t)) && n || ((t = ((Ne = (Ne || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Ne[0].contentDocument).document).write(), t.close(), n = Se(e, t), Ne.detach()), ke[e] = n), n
  }
  c.shrinkWrapBlocks = function() {
    return null != Ee ? Ee : (Ee = !1, (t = C.getElementsByTagName("body")[0]) && t.style ? (e = C.createElement("div"), (n = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", t.appendChild(n).appendChild(e), typeof e.style.zoom !== q && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", e.appendChild(C.createElement("div")).style.width = "5px", Ee = 3 !== e.offsetWidth), t.removeChild(n), Ee) : void 0);
    var e, t, n
  };
  var De, je, Le = /^margin/,
  ...
  e.getComputedStyle ? (De = function(e) {
      ...
      var r, i, o, a, s = e.style;
      return null == (a = (n = n || De(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]), He.test(a) && !_e.test(t) && (r = s.left, (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = r, o && (i.left = o)), void 0 === a ? a : a + "" || "auto"
    }),
    function() {
      var t, n, r, i, o, a, s;
      ...
      function l() {
        var t, n, r, l;
        (n = C.getElementsByTagName("body")[0]) && n.style && (t = C.createElement("div"), (r = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(r).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", i = o = !1, s = !0, e.getComputedStyle && (i = "1%" !== (e.getComputedStyle(t, null) || {}).top, o = "4px" === (e.getComputedStyle(t, null) || {
          width: "4px"
      ...
      }(t = C.createElement("div")).innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", (n = (r = t.getElementsByTagName("a")[0]) && r.style) && (n.cssText = "float:left;opacity:.5", c.opacity = "0.5" === n.opacity, c.cssFloat = !!n.cssFloat, t.style.backgroundClip = "content-box", t.cloneNode(!0).style.backgroundClip = "", c.clearCloneStyle = "content-box" === t.style.backgroundClip, c.boxSizing = "" === n.boxSizing || "" === n.MozBoxSizing || "" === n.WebkitBoxSizing, f.extend(c, {
  ...
  function Ie(e, t) {
    for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)(r = e[a]).style && (o[a] = f._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && z(r) && (o[a] = f._data(r, "olddisplay", Ae(r.nodeName)))) : (i = z(r), (n && "none" !== n || !i) && f._data(r, "olddisplay", i ? n : f.css(r, "display"))));
  ...
  function Ue(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += f.css(e, n + $[o], !0, i)), r ? ("content" === n && (a -= f.css(e, "padding" + $[o], !0, i)), "margin" !== n && (a -= f.css(e, "border" + $[o] + "Width", !0, i))) : (a += f.css(e, "padding" + $[o], !0, i), "padding" !== n && (a += f.css(e, "border" + $[o] + "Width", !0, i)));
    return a
  }
  ...
  function Ve(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if (((i = je(e, t, o)) < 0 || null == i) && (i = e.style[t]), He.test(i)) return i;
  ...
  f.extend({
    ...
    f.cssHooks[t] = {
      get: function(e, n, r) {
        if (n) return Fe.test(f.css(e, "display")) && 0 === e.offsetWidth ? f.swap(e, Re, function() {
          return Ve(e, t, r)
        }) : Ve(e, t, r)
      },
      set: function(e, n, r) {
    ...
    f.cssHooks[e + t] = {
      expand: function(n) {
        for (var r = 0, i = {}, o = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++) i[e + $[r] + t] = o[r] || o[r - 2] || o[0];
        return i
      }
    ...
    css: function(e, t) {
      return I(this, function(e, t, n) {
        var r, i, o = {},
          a = 0;
        if (f.isArray(t)) {
          for (r = De(e), i = t.length; a < i; a++) o[t[a]] = f.css(e, t[a], !1, r);
          return o
        }
    ...
    run: function(e) {
      ...
      return this.options.duration ? this.pos = t = f.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : Je.propHooks._default.set(this), this
    }
  ...
  var Ye, Ge, Qe, Ke, Ze, et, tt, nt = /^(?:toggle|show|hide)$/,
    ...
    ot = [function(e, t, n) {
      ...
      1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], u = f.css(e, "display"), "inline" === ("none" === u ? f._data(e, "olddisplay") || Ae(e.nodeName) : u) && "none" === f.css(e, "float") && (c.inlineBlockNeedsLayout && "inline" !== Ae(e.nodeName) ? h.zoom = 1 : h.display = "inline-block"));
      n.overflow && (h.overflow = "hidden", c.shrinkWrapBlocks() || d.always(function() {
      ...
      if (f.isEmptyObject(p)) "inline" === ("none" === u ? Ae(e.nodeName) : u) && (h.display = u);
        ...
        for (r in g ? "hidden" in g && (m = g.hidden) : g = f._data(e, "fxshow", {}), o && (g.hidden = !m), m ? f(e).show() : d.done(function() {
          ...
          }), p) a = ut(m ? g[r] : 0, r, d), r in g || (g[r] = a.start, m && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
    }],
    at = {
      "*": [function(e, t) {
        var n = this.createTween(e, t),
          ...
          a = (f.cssNumber[e] || "px" !== o && +r) && rt.exec(f.css(n.elem, e)),
          s = 1,
          l = 20;
        if (a && a[3] !== o) {
          o = o || a[3], i = i || [], a = +r || 1;
  ...
  function ct(e, t, n) {
    var r, i, o = 0,
      ...
      l = function() {
        if (i) return !1;
        for (var t = Ye || st(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
    ...
    return f.map(c, ut, u), f.isFunction(u.opts.start) && u.opts.start.call(e, u), f.fx.timer(f.extend(l, {
      elem: e,
      anim: u,
      queue: u.opts.queue
  ...
  }, (Ke = C.createElement("div")).setAttribute("className", "t"), Ke.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", et = Ke.getElementsByTagName("a")[0], tt = (Ze = C.createElement("select")).appendChild(C.createElement("option")), Qe = Ke.getElementsByTagName("input")[0], et.style.cssText = "top:1px", c.getSetAttribute = "t" !== Ke.className, c.style = /top/.test(et.getAttribute("style")), c.hrefNormalized = "/a" === et.getAttribute("href"), c.checkOn = !!Qe.value, c.optSelected = tt.selected, c.enctype = !!C.createElement("form").enctype, Ze.disabled = !0, c.optDisabled = !tt.disabled, (Qe = C.createElement("input")).setAttribute("value", ""), c.input = "" === Qe.getAttribute("value"), Qe.value = "t", Qe.setAttribute("type", "radio"), c.radioValue = "t" === Qe.value;
  var ft = /\r/g;
  f.fn.extend({
    val: function(e) {
      var t, n, r, i = this[0];
  ...
  var dt, pt, ht = f.expr.attrHandle,
  ...
  f.fn.extend({
    ...
    attr: function(e, t, n) {
      var r, i, o = e.nodeType;
      if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === q ? f.prop(e, t, n) : (1 === o && f.isXMLDoc(e) || (t = t.toLowerCase(), r = f.attrHooks[t] || (f.expr.match.bool.test(t) ? pt : dt)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = f.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void f.removeAttr(e, t))
    },
    removeAttr: function(e, t) {
      var n, r, i = 0,
        o = t && t.match(D);
      if (o && 1 === e.nodeType)
        for (; n = o[i++];) r = f.propFix[n] || n, f.expr.match.bool.test(n) ? yt && gt || !mt.test(n) ? e[r] = !1 : e[f.camelCase("default-" + n)] = e[r] = !1 : f.attr(e, n, ""), e.removeAttribute(gt ? n : r)
    },
    attrHooks: {
      type: {
        set: function(e, t) {
    ...
    set: function(e, t, n) {
      return !1 === t ? f.removeAttr(e, n) : yt && gt || !mt.test(n) ? e.setAttribute(!gt && f.propFix[n] || n, n) : e[f.camelCase("default-" + n)] = e[n] = !0, n
    }
  }, f.each(f.expr.match.bool.source.match(/\w+/g), function(e, t) {
    var n = ht[t] || f.find.attr;
    ht[t] = yt && gt || !mt.test(t) ? function(e, t, r) {
      var i, o;
      return r || (o = ht[t], ht[t] = i, i = null != n(e, t, r) ? t.toLowerCase() : null, ht[t] = o), i
    } : function(e, t, n) {
      if (!n) return e[f.camelCase("default-" + t)] ? t.toLowerCase() : null
    }
  }), yt && gt || (f.attrHooks.value = {
    set: function(e, t, n) {
      if (!f.nodeName(e, "input")) return dt && dt.set(e, t, n);
      e.defaultValue = t
    }
  }), gt || (dt = {
    set: function(e, t, n) {
  ...
  f.fn.extend({
    ...
    toggleClass: function(e, t) {
      ...
      return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : f.isFunction(e) ? this.each(function(n) {
        ...
        if ("string" === n)
          for (var t, r = 0, i = f(this), o = e.match(D) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
        else n !== q && "boolean" !== n || (this.className && f._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : f._data(this, "__className__") || "")
      })
    },
    hasClass: function(e) {
  ...
  f.parseJSON = function(t) {
    ...
    var n, r = null,
      i = f.trim(t + "");
    return i && !f.trim(i.replace(Ct, function(e, t, i, o) {
  ...
  Nt = Lt.exec(Et.toLowerCase()) || [], f.extend({
    active: 0,
    lastModified: {},
    etag: {},
    ajaxSettings: {
    ...
    ajax: function(e, t) {
      ...
      if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, c.url = ((e || c.url || Et) + "").replace(kt, "").replace(jt, Nt[1] + "//"), c.type = t.method || t.type || c.method || c.type, c.dataTypes = f.trim(c.dataType || "*").toLowerCase().match(D) || [""], null == c.crossDomain && (n = Lt.exec(c.url.toLowerCase()), c.crossDomain = !(!n || n[1] === Nt[1] && n[2] === Nt[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Nt[3] || ("http:" === Nt[1] ? "80" : "443")))), c.data && c.processData && "string" != typeof c.data && (c.data = f.param(c.data, c.traditional)), Ot(Ht, c, t, w), 2 === b) return w;
      for (r in (s = c.global) && 0 == f.active++ && f.event.trigger("ajaxStart"), c.type = c.type.toUpperCase(), c.hasContent = !Dt.test(c.type), i = c.url, c.hasContent || (c.data && (i = c.url += (Tt.test(i) ? "&" : "?") + c.data, delete c.data), !1 === c.cache && (c.url = St.test(i) ? i.replace(St, "$1_=" + wt++) : i + (Tt.test(i) ? "&" : "?") + "_=" + wt++)), c.ifModified && (f.lastModified[i] && w.setRequestHeader("If-Modified-Since", f.lastModified[i]), f.etag[i] && w.setRequestHeader("If-None-Match", f.etag[i])), (c.data && c.hasContent && !1 !== c.contentType || t.contentType) && w.setRequestHeader("Content-Type", c.contentType), w.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : c.accepts["*"]), c.headers) w.setRequestHeader(r, c.headers[r]);
  ...
  function zt(e, t, n, r) {
    ...
    if (f.isArray(t)) f.each(t, function(t, i) {
      n || Pt.test(e) ? r(e, i) : zt(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
    });
  ...
  f.param = function(e, t) {
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        var e = this.type;
        return this.name && !f(this).is(":disabled") && $t.test(this.nodeName) && !Wt.test(e) && (this.checked || !X.test(e))
      }).map(function(e, t) {
        var n = f(this).val();
      ...
      send: function(n, r) {
        ...
        o.send(e.hasContent && e.data || null), t = function(n, i) {
          ...
          if (t && (i || 4 === o.readyState))
            if (delete Xt[a], t = void 0, o.onreadystatechange = f.noop, i) 4 !== o.readyState && o.abort();
            else {
        ...
        }, e.async ? 4 === o.readyState ? setTimeout(t) : o.onreadystatechange = Xt[a] = t : t()
      },
      abort: function() {
        t && t(void 0, !0)
      }
  ...
  f.ajaxSetup({
    ...
    if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = f.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Yt, "$1" + i) : !1 !== t.jsonp && (t.url += (Tt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
      return a || f.error(i + " was not called"), a[0]
    }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
      a = arguments
    }, r.always(function() {
      e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Jt.push(i)), a && f.isFunction(o) && o(a[0]), a = o = void 0
    }), "script"
  ...
  f.offset = {
    ...
    offset: function(e) {
      ...
      var t, n, r = {
        ...
        i = this[0],
        o = i && i.ownerDocument;
      return o ? (t = o.documentElement, f.contains(t, i) ? (typeof i.getBoundingClientRect !== q && (r = i.getBoundingClientRect()), n = Kt(o), {
    ...
    offsetParent: function() {
      return this.map(function() {
        for (var e = this.offsetParent || Qt; e && !f.nodeName(e, "html") && "static" === f.css(e, "position");) e = e.offsetParent;
        return e || Qt
      })
    }
  }), f.each({
    ...
    f.fn[e] = function(r) {
      return I(this, function(e, r, i) {
        ...
        o ? o.scrollTo(n ? f(o).scrollLeft() : i, n ? i : f(o).scrollTop()) : e[r] = i
      }, e, r, arguments.length, null)
    }
  }), f.each(["top", "left"], function(e, t) {
    f.cssHooks[t] = qe(c.pixelPosition, function(e, n) {
      if (n) return n = je(e, t), He.test(n) ? f(e).position()[t] + "px" : n
    })
  }), f.each({
    Height: "height",
    Width: "width"
  ...
  return f.noConflict = function(t) {
    return e.$ === f && (e.$ = en), t && e.jQuery === f && (e.jQuery = Zt), f
  }, typeof t === q && (e.jQuery = e.$ = f), f
});
